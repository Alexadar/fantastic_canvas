...
|---|---|---|
| `ghcr.io/alexadar/fantastic:amd64` | **Intel / AMD** x86-64 (a.k.a. x64) — most Linux servers, Intel Macs/PCs | `:v0.5.3-amd64` |
| `ghcr.io/alexadar/fantastic:arm64` | **Apple silicon / ARM** (aarch64) — M-series Macs, ARM servers, Raspberry Pi | `:v0.5.3-arm64` |
