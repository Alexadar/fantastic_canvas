...
async def test_persistence_routing_through_file_agent(seeded_kernel, file_agent, tmp_path):
            ...
            [
                {
                    "tool_call": {
                        ...
                        "arguments": {
                            "target_id": b,
                            "payload": {"type": "send", "text": "what color is the sky?"},
                        },
                    }
                }
            ],
...
async def test_scheduler_fires_through_kernel_send(seeded_kernel, file_agent):
    ...
    await seeded_kernel.send(sid, {"type": "tick_now", "schedule_id": sch["schedule_id"]})
