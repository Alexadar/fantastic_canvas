...
def _bundled_html() -> str:
    ...
    return (resources.files("canvas_webapp") / "webapp" / "index.html").read_text("utf-8")


def _default_bganim_source() -> str:
    return (resources.files("canvas_webapp") / "webapp" / "default_bganim.js").read_text("utf-8")


def _bganim_guide() -> str:
    return (resources.files("canvas_webapp") / "webapp" / "bganim.md").read_text("utf-8")
